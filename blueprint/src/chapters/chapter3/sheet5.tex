...
\begin{definition}
    ...
    \lean{AlgebraInLean.Subgroups.Kernel}
    \leanok
...
\begin{definition}
    ...
    \lean{AlgebraInLean.Subgroups.Image}
    \leanok
    \uses{definition : Subgroup}
...
\begin{definition}
    ...
    \lean{AlgebraInLean.Subgroups.normal}
    \leanok
    \uses{definition : Subgroup}
...
\begin{theorem}
    ...
    \lean{AlgebraInLean.Subgroups.Minimal_normal}
    \leanok
    \uses{definition : Subgroup, definition : Minimal}
    The minimal subgroup of $G$ is a normal subgroup of $G$.
\end{theorem}

\begin{theorem}
    \label{theorem : Maximal_normal}
    \lean{AlgebraInLean.Subgroups.Maximal_normal}
    \leanok
    \uses{definition : Subgroup, definition : Maximal}
    The maximal subgroup of $G$ is a normal subgroup of $G$.
\end{theorem}

\begin{theorem}
    \label{theorem : Kernel_normal}
    \lean{AlgebraInLean.Subgroups.Kernel_normal}
    \leanok
...
\begin{definition}
    ...
    \lean{AlgebraInLean.Subgroups.Normalizer}
    \leanok
    \uses{definition : Subgroup}
...
\begin{definition}
    ...
    \lean{AlgebraInLean.Subgroups.Centralizer}
    \leanok
    \uses{definition : Subgroup}
...
\begin{definition}
    ...
    \lean{AlgebraInLean.Subgroups.Center}
    \leanok
...
\begin{theorem}
    ...
    \lean{AlgebraInLean.Subgroups.homomorphism_inj_iff_kernel_trivial}
    \leanok
...
\begin{theorem}
    ...
    \lean{AlgebraInLean.Subgroups.homomorphism_surj_iff_image_complete}
    \leanok
