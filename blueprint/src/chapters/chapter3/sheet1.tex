...
\begin{proposition}
    ...
    \begin{enumerate}
        \item $H \neq \{\}$
        \item \all x, y \in H, $\mu x (\io y) \in H$
\end{proposition}
...
\begin{definition}
    ...
    \leanok
    \uses{definition : Subgroup}
    Let $G$, $H$, and $K$ be groups such that $K \le H$ and $H \le G$. Then $K \le G$.
\end{theorem}
...
\begin{theorem}
    ...
    \leanok
    \uses{definition : Subgroup}
    Let $G$ be a group. For $J$, $K$, $L \le G$ then if $J \le K$ and $K \le L$ then $J \le L$.
\end{theorem}
