...
\begin{definition}[$Dihedral Group$]
    ...
    It is represented by a pair of a boolean and an element of \verb!Fin n!. The
    boolean represents whether the element is a rotation or not, and the element
    of \verb!Fin n! represents how much the first vertex is rotated. The identity is a
