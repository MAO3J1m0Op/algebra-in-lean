...
This is an interactive problem set, where you'll learn to use Lean 4, a theorem prover and
programming language, while exploring the basics of abstract algebra. Through formalizing and
proving theorems on groups, rings, and fields, you'll become comfortable with using Lean 4 to help
...
/-
Note that as you write each tactic line by line, the goal updates. You can go back to see how the
goal updated by simply placing your cursor at the right end of any line.
