...
/- The last example of a group we will go over is the dihedral group, Dn. Similarly to
...
/- First, we have to claim that D3 is a group. This is simple, since we have already proved it-/
